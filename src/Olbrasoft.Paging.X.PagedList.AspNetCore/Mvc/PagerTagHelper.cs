...
namespace Olbrasoft.Paging.X.PagedList.AspNetCore.Mvc
{
    ...
    public class PagerTagHelper : TagHelper
    {
        ...
        public PagedListRenderOptionsBase Options { get; set; } = new PagedListRenderOptions { NextElementClass ="page-link" , LiElementClasses = new[] { "page-item" }, PageClasses = new[] { "page-link" }, UlElementClasses = new[] { "pagination", "justify-content-center" } };
        ...
        private TagBuilder First(IUrlHelper urlHelper)
        {
            ...
            foreach (var @class in Options.PageClasses)
            {
        ...
        private TagBuilder Previous(IUrlHelper urlHelper)
        {
            ...
            var previous = new TagBuilder("a");
             ...
             previous.AddCssClass(Options.NextElementClass);
